                    ...
                    <tbody id="tbody">
                        @foreach ($data as $kpi_child)
                            <tr>
                                ...
                                <td>
                                    <textarea name="duties_activities[]" id="" cols="20" rows="10">{{ $kpi_child['dutiesActivities'] }}</textarea>
                                </td>
                                <td>
                                    <textarea name="skill[]" id="" cols="20" rows="10">{{ $kpi_child['skill'] }}</textarea>
                                </td>
                                <td>
                                    <textarea name="" id="" cols="20" rows="10" disabled></textarea>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
