    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#btn_add_more").click(function() {
                ...
                html += '<div class="form-group row"><label class="col-form-label col-lg-4">Task Target:</label><div class="col-lg-8"><input type="text" class="form-control target" onkeyup=checkEmpty(this) name="target[]" placeholder="Task target" required></div></div>';
                html += '<div class="form-group row"><label class="col-form-label col-lg-4">Task Details:</label><div class="col-lg-8"><textarea rows="3" cols="3" class="form-control task_description" onkeyup=checkEmpty(this) name="task_description[]" placeholder="Task description" required></textarea></div></div>';
                html += '<div class="form-group row"><label class="col-form-label col-lg-4">Steps to Achieve:</label><div class="col-lg-8"><textarea rows="3" cols="3" class="form-control duties_activities" onkeyup=checkEmpty(this) name="duties_activities[]" placeholder="Steps" required></textarea></div></div>';
                html += '<div class="form-group row"><label class="col-form-label col-lg-4">Required Skills:</label><div class="col-lg-8"><textarea rows="3" cols="3" class="form-control skill" onkeyup=checkEmpty(this) name="skill[]" placeholder="Skills" required></textarea></div></div>';
                html += '<div class="form-group row"><label class="col-form-label col-lg-4">Weight on Total Tasks:</label><div class="col-lg-8"><input id="ratio' + count_job + '" type="number" name="ratio[]" class="form-control ratio" onkeyup=checkEmpty(this) min="0" max="100" placeholder="Max 100 percent" required></div></div>';
                html += '</div></div></div>';
