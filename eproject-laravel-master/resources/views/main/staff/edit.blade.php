...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h1 class="pt-3 pl-3 pr-3">{{(Auth::user()->id)==$data['id']?'Update Your Information':'Update Employee Information'}}</h1>
        ...
        <div class="card-body">
            <form action="{{ action('StaffController@postEditStaff') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>City/District/Ward<span class="text-danger">*</span></label>
                ...
                <div class="text-left">
                    <button type="submit" class="btn btn-success mr-1">Save <i class="icon-paperplane ml-2"></i></button>
