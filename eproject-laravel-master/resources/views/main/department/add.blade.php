...
@section('content')
    ...
    <div class="form-group d-flex">
        <div class="ml-1">
            <button id="register_leave" class="btn btn-info" data-toggle="modal" data-target="#exampleModalCenter2">Add Department</button>
        </div>
    </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{ action('DepartmentController@CreateDepartment') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label">Department Name in Vietnamese</label>
                            <div class="col-lg-9">
