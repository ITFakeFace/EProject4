...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      ...
      @if(auth()->user()->department == 2 or auth()->user()->department == 5)
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-charts" aria-expanded="false" aria-controls="ui-charts">
              <i class="ti-layout-column3 menu-icon"></i>
              <span class="menu-title">Departments</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{action('DepartmentController@index')}}">All Departments</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{action('DepartmentController@listUndo')}}">All Inactive Departments</a></li>
              </ul>
            </div>
        </li>
        <!-- Staff -->
