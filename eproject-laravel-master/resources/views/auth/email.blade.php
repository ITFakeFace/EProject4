...
<head>
  ...
  <title>FHRM-Reset Password</title>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="http://www.127.0.0.1:8000" target="_blank" style="display: inline-block;">
                <img src="{{url('/images/Logo-FutureHRM-index.svg')}}" alt="Logo" border="0" style="display: block; width: 128px; max-width: 128px; min-width: 64px;">
              </a>
            </td>
          </tr>
        </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="{{ url('auth/reset?token='.$token) }}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Đặt lại mật khẩu</a>
                        </td>
                      </tr>
                    </table>
                  </td>
